...
const float spherePos1[64][2] = {
     {-15.0f, 15.0f}, {-15.0f, 15.0f}, {-0.75f, 1.75f}, {-0.25f, 1.75f}, {0.25f, 1.75f}, {0.75f, 1.75f}, {1.25f, 1.75f}, {1.75f, 1.75f},
    {-15.0f, 15.0f}, {-15.0f, 15.0f}, {-0.75f, 1.25f}, {-0.25f, 1.25f}, {0.25f, 1.25f}, {0.75f, 1.25f}, {1.25f, 1.25f}, {1.75f, 1.25f},
    {-15.0f, 15.0f}, {-15.0f, 15.0f}, {-0.75f, 0.75f}, {-0.25f, 0.75f}, {15.0f, 15.0f}, {15.0f, 15.0f}, {1.25f, 0.75f}, {1.75f, 0.75f},
    {-15.0f, 15.0f}, {-15.0f, 15.0f}, {-0.75f, 0.25f}, {-0.25f, 0.25f}, {15.0f, 15.0f}, {15.0f, 15.0f}, {1.25f, 0.25f}, {1.75f, 0.25f},
    {-15.0f, -15.0f}, {-15.0f, -15.0f}, {-0.75f, -0.25f}, {-0.25f, -0.25f}, {15.0f, -15.0f}, {15.0f, -15.0f}, {1.25f, -0.25f}, {1.75f, -0.25f},
    {-15.0f, -15.0f}, {-15.0f, -15.0f}, {-0.75f, -0.75f}, {-0.25f, -0.75f}, {15.0f, -15.0f}, {15.0f, -15.0f}, {1.25f, -0.75f}, {1.75f, -0.75f},
    {-15.0f, -15.0f}, {-15.0f, -15.0f}, {-0.75f, -1.25f}, {-0.25f, -1.25f}, {0.25f, -1.25f}, {0.75f, -1.25f}, {1.25f, -1.25f}, {1.75f, -1.25f},
    {-15.0f, -15.0f}, {-15.0f, -15.0f}, {-0.75f, -1.75f}, {-0.25f, -1.75f}, {0.25f, -1.75f}, {0.75f, -1.75f}, {1.25f, -1.75f}, {1.75f, -1.75f}
